...
use std::str;
use esp_idf_svc::mqtt::client::{EspMqttEvent, EventPayload, Details};
use crate::thermostat::{ThermostatEvent, ThermostatConfiguration, ThermostatStateMsg, ThermostatCommand};
...
pub fn publish_status(client: &mut EspMqttClient, state_topic: &str, cmd: ThermostatCommand) -> Result<u32, Box< dyn std::error::Error>> {
